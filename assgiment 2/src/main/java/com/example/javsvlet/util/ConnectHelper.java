...
public class ConnectHelper {
    private final static String DATABASE_URL_FORMAT = "jdbc:mysql://%s:%d/%s?useUnicode=true&contentEncoding=UTF-8";//tương ứng ở format
    private final static String DATABASE_SERVER = "localhost";
    private final static int DATABASE_PORT = 3306;
    private final static String DATABASE_NAME = "assgiment2";
